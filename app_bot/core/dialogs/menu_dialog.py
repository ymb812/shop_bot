...
main_menu_dialog = Dialog(
    ...
    Window(
        ...
        Column(
            ...
            Button(Const(text=_('FAQ_BUTTON')), id='faq', on_click=ProductsCallbackHandler.main_menu_buttons_handler),
            Button(Const(text=_('ABOUT_BUTTON')), id='about', on_click=ProductsCallbackHandler.main_menu_buttons_handler),
            Button(Const(text=_('CONTACTS_BUTTON')), id='contacts', on_click=ProductsCallbackHandler.main_menu_buttons_handler),
